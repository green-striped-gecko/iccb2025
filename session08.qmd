...
## Exercise 1: Identify sex-linked loci and use them for sexing ![](images/task.png){.class width="48" height="48"}
...
## Exercise 2: Observe the effects of not removing sex-linked loci on population genetic analyses ![](images/task.png){.class width="48" height="48"}
