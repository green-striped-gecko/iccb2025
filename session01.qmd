...
![](images/task.png){.class width="48" height="48"} How many individuals have been genotyped? How many SNP loci have been scored? What is the percentage of missing data? This is referring to the `testset.gl` data set you have interrogated above.
